var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="handwashing.gif" alt="How to wash your hands" class="svelte-1cdgrsa">`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-1w4tjz1");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-1w4tjz1");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	let mounted;
    	let dispose;
    	progressbar = new ProgressBar({ props: { progress: /*progress*/ ctx[3] } });
    	...
    	return {
    		c() {
    			...
    			attr(button, "class", "start svelte-1kfqs2b");
    			attr(div1, "bp", "grid");
    		},
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(button, "click", /*startTimer*/ ctx[4]);
    				mounted = true;
    			}
    		},
    		p(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*buttonText*/ 4) set_data(t4, /*buttonText*/ ctx[2]);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function startTimer() {
    		...
    		$$invalidate(2, buttonText = "Lavando manos...");
    		...
    		const timer = setInterval(
    			() => {
    				...
    				if (secondLeft == 0) {
    					...
    					$$invalidate(2, buttonText = "Re Iniciar");
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*secondLeft*/ 1) {
    			 $$invalidate(3, progress = (totalSeconds - secondLeft) / totalSeconds * 100);
    		}
    	};

    	return [secondLeft, isRunning, buttonText, progress, startTimer];
    }
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			t3 = space();
    			h30 = element("h3");
    			h30.innerHTML = `<a href="https://www.who.int/gpsc/clean_hands_protection/en/">Image Source</a>`;
    			t5 = space();
    			h31 = element("h3");
    			h31.innerHTML = `<a href="https://freesound.org/people/metrostock99/sounds/345086/">Sound Source</a>`;
    			t7 = space();
    			audio_1 = element("audio");
    			audio_1.innerHTML = `<source src="sound.wav">`;
    			attr(h1, "class", "svelte-1ow1cbm");
    			attr(h30, "class", "svelte-1ow1cbm");
    			attr(h31, "class", "svelte-1ow1cbm");
    		},
    		m(target, anchor) {
